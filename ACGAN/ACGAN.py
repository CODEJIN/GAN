    ...
    def Tensor_Generate(self):        
        ...
        discriminator_Loss_for_Original = tf.reduce_mean(
            tf.nn.sigmoid_cross_entropy_with_logits(
                ...
                logits = discrimination_Activation_for_Original
                )
            )
...
if __name__ == "__main__":
    new_ACGAN = ACGAN(noise_Size = 100, hidden_Unit_Size = 512, learning_Rate = 0.0002);
    new_ACGAN.Train(test_Step = 10000, checkpoint_Step = 10000);
