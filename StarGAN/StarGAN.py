...
if __name__ == "__main__":
    new_StarGAN = StarGAN(
        select_Attribute_List = ["Black_Hair", "Blond_Hair", "Brown_Hair", "Male", "Young", "Pale_Skin"],   #None,        
        gan_Loss_Type = "WGAN",
        batch_Size = 16,
        learning_Rate = 0.0001,
        );
    ...
    new_StarGAN.Train(
        test_File_Name_List = [
            ...
            "D:/Simulation_Raw_Data/CelebA/Img/189026.jpg",
            "D:/Simulation_Raw_Data/CelebA/Img/189384.jpg",
            ],
